        ...
        <section id="aeropuerto" className="mt-24 scroll-mt-24">
          <div className="grid md:grid-cols-12 gap-12 items-start">
            <div className="relative md:col-span-5 order-2 md:order-1">
              ...
              <div className="absolute -top-2 right-2 w-48 md:w-56 md:-top-5 md:-right-5 rotate-1 rounded-xl border border-border bg-white/80 backdrop-blur shadow-md p-4">
        ...
        <section id="camino" className="mt-24 scroll-mt-24">
          <div className="grid md:grid-cols-12 gap-12 items-start">
            ...
            <div className="md:col-span-5 relative">
              ...
              <div className="absolute -bottom-2 left-2 w-48 md:w-56 md:-bottom-5 md:-left-5 -rotate-3 rounded-xl border border-border bg-white/80 backdrop-blur shadow-md p-4">
        ...
        <section id="mensajeria" className="mt-24 scroll-mt-24">
          <div className="grid md:grid-cols-12 gap-12 items-start">
            <div className="md:col-span-5 relative">
              ...
              <div className="absolute -top-2 left-2 w-48 md:w-56 md:-top-5 md:-left-5 rotate-2 rounded-xl border border-border bg-white/80 backdrop-blur shadow-md p-4">
