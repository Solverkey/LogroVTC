...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  try {
    ...
    if (a) {
      ...
      const url = `https://logrovtc.com/aeropuertos/${slug}`;
      return {
        title,
        description,
  ...
  const url = `https://logrovtc.com/aeropuertos/${airport.slug}`;
  return {
    title,
    description,
    alternates: { canonical: url },
...
export default async function AirportPage({ params }: PageProps) {
  ...
  const serviceSchema = {
    ...
    provider: {
      ...
      url: `https://logrovtc.com/aeropuertos/${airport.slug}`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Aeropuertos", item: "https://logrovtc.com/aeropuertos" },
      { "@type": "ListItem", position: 3, name: airport.name, item: `https://logrovtc.com/aeropuertos/${airport.slug}` },
    ],
  } as const;
